...
public interface PengirimanRepository extends JpaRepository<Pengiriman, UUID> {
    ...
    /** Digunakan Admin untuk melihat pengiriman yang sudah disetujui Mandor */
    List<Pengiriman> findByStatusPersetujuanMandor(String statusPersetujuanMandor);

    /** Filter kombinasi — opsional untuk query lanjutan */
    List<Pengiriman> findByMandorIdAndSupirId(UUID mandorId, UUID supirId);
}
